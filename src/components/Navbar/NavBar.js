...
export function NavbarDefault() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <Typography
        ...
        variant="small"
        color="blue-gray"
        className="flex items-center gap-x-2 p-1 font-medium transition-transform transform hover:translate-y-1 hover:text-white"
      >
        <svg
          width="16"
          height="15"
  ...
  return (
    <Navbar className="mx-auto max-w-screen px-4 py-2 lg:px-8 lg:py-4 bg-neutral-600">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        ...
        <div className="flex items-center gap-x-1 ">
          <Button
            variant="text"
            size="sm"
            className="hidden lg:inline-block transition-transform transform hover:translate-y-1 hover:text-white"
          >
            <span>Log In</span>
          </Button>
          <Button
